...
export const RestaurantFindFirstSelectSchema: z.ZodType<Prisma.RestaurantSelect> = z.object({
...
export const RestaurantFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    address: z.boolean().optional(),
    city: z.boolean().optional(),
...
export const RestaurantFindFirstSchema: z.ZodType<Prisma.RestaurantFindFirstArgs> = z.object({ select: RestaurantFindFirstSelectSchema.optional(), include: z.lazy(() => RestaurantIncludeObjectSchema.optional()), orderBy: z.union([RestaurantOrderByWithRelationInputObjectSchema, RestaurantOrderByWithRelationInputObjectSchema.array()]).optional(), where: RestaurantWhereInputObjectSchema.optional(), cursor: RestaurantWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([RestaurantScalarFieldEnumSchema, RestaurantScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.RestaurantFindFirstArgs>;

export const RestaurantFindFirstZodSchema = z.object({ select: RestaurantFindFirstSelectSchema.optional(), include: z.lazy(() => RestaurantIncludeObjectSchema.optional()), orderBy: z.union([RestaurantOrderByWithRelationInputObjectSchema, RestaurantOrderByWithRelationInputObjectSchema.array()]).optional(), where: RestaurantWhereInputObjectSchema.optional(), cursor: RestaurantWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([RestaurantScalarFieldEnumSchema, RestaurantScalarFieldEnumSchema.array()]).optional() }).strict();