...
export const CommentCreateOneSchema = z.object({ select: CommentSelectObjectSchema.optional(), include: CommentIncludeObjectSchema.optional(), data: z.union([CommentCreateInputObjectSchema, CommentUncheckedCreateInputObjectSchema])  })