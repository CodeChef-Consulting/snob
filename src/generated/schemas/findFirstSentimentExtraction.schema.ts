...
export const SentimentExtractionFindFirstSelectSchema: z.ZodType<Prisma.SentimentExtractionSelect> = z.object({
...
export const SentimentExtractionFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    post: z.boolean().optional(),
    postId: z.boolean().optional(),
    comment: z.boolean().optional(),
...
export const SentimentExtractionFindFirstSchema: z.ZodType<Prisma.SentimentExtractionFindFirstArgs> = z.object({ select: SentimentExtractionFindFirstSelectSchema.optional(), include: z.lazy(() => SentimentExtractionIncludeObjectSchema.optional()), orderBy: z.union([SentimentExtractionOrderByWithRelationInputObjectSchema, SentimentExtractionOrderByWithRelationInputObjectSchema.array()]).optional(), where: SentimentExtractionWhereInputObjectSchema.optional(), cursor: SentimentExtractionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([SentimentExtractionScalarFieldEnumSchema, SentimentExtractionScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.SentimentExtractionFindFirstArgs>;

export const SentimentExtractionFindFirstZodSchema = z.object({ select: SentimentExtractionFindFirstSelectSchema.optional(), include: z.lazy(() => SentimentExtractionIncludeObjectSchema.optional()), orderBy: z.union([SentimentExtractionOrderByWithRelationInputObjectSchema, SentimentExtractionOrderByWithRelationInputObjectSchema.array()]).optional(), where: SentimentExtractionWhereInputObjectSchema.optional(), cursor: SentimentExtractionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([SentimentExtractionScalarFieldEnumSchema, SentimentExtractionScalarFieldEnumSchema.array()]).optional() }).strict();