...
export const BatchJobFindFirstSelectSchema: z.ZodType<Prisma.BatchJobSelect> = z.object({
...
export const BatchJobFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    geminiJobName: z.boolean().optional(),
    displayName: z.boolean().optional(),
    model: z.boolean().optional(),
...
export const BatchJobFindFirstSchema: z.ZodType<Prisma.BatchJobFindFirstArgs> = z.object({ select: BatchJobFindFirstSelectSchema.optional(),  orderBy: z.union([BatchJobOrderByWithRelationInputObjectSchema, BatchJobOrderByWithRelationInputObjectSchema.array()]).optional(), where: BatchJobWhereInputObjectSchema.optional(), cursor: BatchJobWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([BatchJobScalarFieldEnumSchema, BatchJobScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.BatchJobFindFirstArgs>;

export const BatchJobFindFirstZodSchema = z.object({ select: BatchJobFindFirstSelectSchema.optional(),  orderBy: z.union([BatchJobOrderByWithRelationInputObjectSchema, BatchJobOrderByWithRelationInputObjectSchema.array()]).optional(), where: BatchJobWhereInputObjectSchema.optional(), cursor: BatchJobWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([BatchJobScalarFieldEnumSchema, BatchJobScalarFieldEnumSchema.array()]).optional() }).strict();