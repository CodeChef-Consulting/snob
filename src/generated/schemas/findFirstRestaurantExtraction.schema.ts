...
export const RestaurantExtractionFindFirstSelectSchema: z.ZodType<Prisma.RestaurantExtractionSelect> = z.object({
...
export const RestaurantExtractionFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    post: z.boolean().optional(),
    postId: z.boolean().optional(),
    comment: z.boolean().optional(),
...
export const RestaurantExtractionFindFirstSchema: z.ZodType<Prisma.RestaurantExtractionFindFirstArgs> = z.object({ select: RestaurantExtractionFindFirstSelectSchema.optional(), include: z.lazy(() => RestaurantExtractionIncludeObjectSchema.optional()), orderBy: z.union([RestaurantExtractionOrderByWithRelationInputObjectSchema, RestaurantExtractionOrderByWithRelationInputObjectSchema.array()]).optional(), where: RestaurantExtractionWhereInputObjectSchema.optional(), cursor: RestaurantExtractionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([RestaurantExtractionScalarFieldEnumSchema, RestaurantExtractionScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.RestaurantExtractionFindFirstArgs>;

export const RestaurantExtractionFindFirstZodSchema = z.object({ select: RestaurantExtractionFindFirstSelectSchema.optional(), include: z.lazy(() => RestaurantExtractionIncludeObjectSchema.optional()), orderBy: z.union([RestaurantExtractionOrderByWithRelationInputObjectSchema, RestaurantExtractionOrderByWithRelationInputObjectSchema.array()]).optional(), where: RestaurantExtractionWhereInputObjectSchema.optional(), cursor: RestaurantExtractionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([RestaurantExtractionScalarFieldEnumSchema, RestaurantExtractionScalarFieldEnumSchema.array()]).optional() }).strict();