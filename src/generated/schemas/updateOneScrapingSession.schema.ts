...
export const ScrapingSessionUpdateOneSchema: z.ZodType<Prisma.ScrapingSessionUpdateArgs> = z.object({ select: ScrapingSessionSelectObjectSchema.optional(),  data: z.union([ScrapingSessionUpdateInputObjectSchema, ScrapingSessionUncheckedUpdateInputObjectSchema]), where: ScrapingSessionWhereUniqueInputObjectSchema }).strict() as unknown as z.ZodType<Prisma.ScrapingSessionUpdateArgs>;

export const ScrapingSessionUpdateOneZodSchema = z.object({ select: ScrapingSessionSelectObjectSchema.optional(),  data: z.union([ScrapingSessionUpdateInputObjectSchema, ScrapingSessionUncheckedUpdateInputObjectSchema]), where: ScrapingSessionWhereUniqueInputObjectSchema }).strict();