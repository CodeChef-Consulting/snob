...
export const ScrapingSessionUpsertOneSchema: z.ZodType<Prisma.ScrapingSessionUpsertArgs> = z.object({ select: ScrapingSessionSelectObjectSchema.optional(), include: ScrapingSessionIncludeObjectSchema.optional(), where: ScrapingSessionWhereUniqueInputObjectSchema, create: z.union([ ScrapingSessionCreateInputObjectSchema, ScrapingSessionUncheckedCreateInputObjectSchema ]), update: z.union([ ScrapingSessionUpdateInputObjectSchema, ScrapingSessionUncheckedUpdateInputObjectSchema ]) }).strict() as unknown as z.ZodType<Prisma.ScrapingSessionUpsertArgs>;

export const ScrapingSessionUpsertOneZodSchema = z.object({ select: ScrapingSessionSelectObjectSchema.optional(), include: ScrapingSessionIncludeObjectSchema.optional(), where: ScrapingSessionWhereUniqueInputObjectSchema, create: z.union([ ScrapingSessionCreateInputObjectSchema, ScrapingSessionUncheckedCreateInputObjectSchema ]), update: z.union([ ScrapingSessionUpdateInputObjectSchema, ScrapingSessionUncheckedUpdateInputObjectSchema ]) }).strict();