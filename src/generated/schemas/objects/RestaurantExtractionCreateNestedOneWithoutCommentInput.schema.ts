...
export const RestaurantExtractionCreateNestedOneWithoutCommentInputObjectSchema: z.ZodType<Prisma.RestaurantExtractionCreateNestedOneWithoutCommentInput> = makeSchema() as unknown as z.ZodType<Prisma.RestaurantExtractionCreateNestedOneWithoutCommentInput>;
export const RestaurantExtractionCreateNestedOneWithoutCommentInputObjectZodSchema = makeSchema();
