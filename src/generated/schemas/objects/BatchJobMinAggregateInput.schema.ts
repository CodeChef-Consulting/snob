...
export const BatchJobMinAggregateInputObjectSchema: z.ZodType<Prisma.BatchJobMinAggregateInputType> = makeSchema() as unknown as z.ZodType<Prisma.BatchJobMinAggregateInputType>;
export const BatchJobMinAggregateInputObjectZodSchema = makeSchema();
