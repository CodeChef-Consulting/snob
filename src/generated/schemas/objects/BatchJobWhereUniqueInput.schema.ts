...
const makeSchema = () => z.object({
  ...
  geminiJobName: z.string().optional()
        ...
        const singles: string[] = ["id","geminiJobName"] as string[];
...
export const BatchJobWhereUniqueInputObjectSchema: z.ZodType<Prisma.BatchJobWhereUniqueInput> = makeSchema() as unknown as z.ZodType<Prisma.BatchJobWhereUniqueInput>;
export const BatchJobWhereUniqueInputObjectZodSchema = makeSchema();
