...
export default function RestaurantMap({ onShowAbout }: { onShowAbout?: () => void }) {
  ...
  return (
    <div className="h-screen flex relative">
      ...
      <div className="fixed md:absolute top-2 right-2 md:top-4 md:right-4 z-30 flex gap-2">
        {/* About button */}
        <button
          onClick={() => onShowAbout?.()}
          className="bg-white/80 backdrop-blur-lg rounded-full shadow-lg p-2 hover:bg-white transition-colors"
          aria-label="About"
        >
          <svg
