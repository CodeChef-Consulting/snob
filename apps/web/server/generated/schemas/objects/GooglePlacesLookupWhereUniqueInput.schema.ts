...
import { GooglePlacesLookupYearMonthGoogleSKUCompoundUniqueInputObjectSchema as GooglePlacesLookupYearMonthGoogleSKUCompoundUniqueInputObjectSchema } from './GooglePlacesLookupYearMonthGoogleSKUCompoundUniqueInput.schema'

const makeSchema = () => z.object({
  id: z.number().int().optional(),
  year_month_googleSKU: z.lazy(() => GooglePlacesLookupYearMonthGoogleSKUCompoundUniqueInputObjectSchema).optional()
}).strict().superRefine((obj, ctx) => {
        const presentTop = (k: string) => (obj as any)[k] != null;
        const singles: string[] = ["id"] as string[];
        const groups: string[][] = [["year","month","googleSKU"]] as string[][];
...
export const GooglePlacesLookupWhereUniqueInputObjectSchema: z.ZodType<Prisma.GooglePlacesLookupWhereUniqueInput> = makeSchema() as unknown as z.ZodType<Prisma.GooglePlacesLookupWhereUniqueInput>;
export const GooglePlacesLookupWhereUniqueInputObjectZodSchema = makeSchema();
