...
export const RestaurantLocationFindFirstSelectSchema: z.ZodType<Prisma.RestaurantLocationSelect> = z.object({
...
export const RestaurantLocationFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    address: z.boolean().optional(),
    city: z.boolean().optional(),
...
export const RestaurantLocationFindFirstSchema: z.ZodType<Prisma.RestaurantLocationFindFirstArgs> = z.object({ select: RestaurantLocationFindFirstSelectSchema.optional(), include: z.lazy(() => RestaurantLocationIncludeObjectSchema.optional()), orderBy: z.union([RestaurantLocationOrderByWithRelationInputObjectSchema, RestaurantLocationOrderByWithRelationInputObjectSchema.array()]).optional(), where: RestaurantLocationWhereInputObjectSchema.optional(), cursor: RestaurantLocationWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([RestaurantLocationScalarFieldEnumSchema, RestaurantLocationScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.RestaurantLocationFindFirstArgs>;

export const RestaurantLocationFindFirstZodSchema = z.object({ select: RestaurantLocationFindFirstSelectSchema.optional(), include: z.lazy(() => RestaurantLocationIncludeObjectSchema.optional()), orderBy: z.union([RestaurantLocationOrderByWithRelationInputObjectSchema, RestaurantLocationOrderByWithRelationInputObjectSchema.array()]).optional(), where: RestaurantLocationWhereInputObjectSchema.optional(), cursor: RestaurantLocationWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([RestaurantLocationScalarFieldEnumSchema, RestaurantLocationScalarFieldEnumSchema.array()]).optional() }).strict();