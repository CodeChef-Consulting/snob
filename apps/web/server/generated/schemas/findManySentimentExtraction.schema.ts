...
export const SentimentExtractionFindManySelectSchema: z.ZodType<Prisma.SentimentExtractionSelect> = z.object({
...
export const SentimentExtractionFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    post: z.boolean().optional(),
    postId: z.boolean().optional(),
    comment: z.boolean().optional(),
...
export const SentimentExtractionFindManySchema: z.ZodType<Prisma.SentimentExtractionFindManyArgs> = z.object({ select: SentimentExtractionFindManySelectSchema.optional(), include: z.lazy(() => SentimentExtractionIncludeObjectSchema.optional()), orderBy: z.union([SentimentExtractionOrderByWithRelationInputObjectSchema, SentimentExtractionOrderByWithRelationInputObjectSchema.array()]).optional(), where: SentimentExtractionWhereInputObjectSchema.optional(), cursor: SentimentExtractionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([SentimentExtractionScalarFieldEnumSchema, SentimentExtractionScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.SentimentExtractionFindManyArgs>;

export const SentimentExtractionFindManyZodSchema = z.object({ select: SentimentExtractionFindManySelectSchema.optional(), include: z.lazy(() => SentimentExtractionIncludeObjectSchema.optional()), orderBy: z.union([SentimentExtractionOrderByWithRelationInputObjectSchema, SentimentExtractionOrderByWithRelationInputObjectSchema.array()]).optional(), where: SentimentExtractionWhereInputObjectSchema.optional(), cursor: SentimentExtractionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([SentimentExtractionScalarFieldEnumSchema, SentimentExtractionScalarFieldEnumSchema.array()]).optional() }).strict();