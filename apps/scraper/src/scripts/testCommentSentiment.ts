...
async function testCommentSentiment(commentId: number) {
  ...
  try {
    ...
    console.log(
      `   Has Restaurant Extraction: ${!!comment.restaurantExtraction}`
    );
    console.log(
      `   Has Sentiment Extraction: ${!!comment.sentimentExtraction}`
    );

    if (comment.restaurantExtraction) {
      console.log(`\n   Restaurant Extraction:`);
      console.log(
        `      isSubjective: ${comment.restaurantExtraction.isSubjective}`
      );
      console.log(
