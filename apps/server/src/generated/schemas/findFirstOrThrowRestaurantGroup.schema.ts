...
export const RestaurantGroupFindFirstOrThrowSelectSchema: z.ZodType<Prisma.RestaurantGroupSelect> = z.object({
...
export const RestaurantGroupFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    rawScore: z.boolean().optional(),
    normalizedScore: z.boolean().optional(),
...
export const RestaurantGroupFindFirstOrThrowSchema: z.ZodType<Prisma.RestaurantGroupFindFirstOrThrowArgs> = z.object({ select: RestaurantGroupFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => RestaurantGroupIncludeObjectSchema.optional()), orderBy: z.union([RestaurantGroupOrderByWithRelationInputObjectSchema, RestaurantGroupOrderByWithRelationInputObjectSchema.array()]).optional(), where: RestaurantGroupWhereInputObjectSchema.optional(), cursor: RestaurantGroupWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([RestaurantGroupScalarFieldEnumSchema, RestaurantGroupScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.RestaurantGroupFindFirstOrThrowArgs>;

export const RestaurantGroupFindFirstOrThrowZodSchema = z.object({ select: RestaurantGroupFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => RestaurantGroupIncludeObjectSchema.optional()), orderBy: z.union([RestaurantGroupOrderByWithRelationInputObjectSchema, RestaurantGroupOrderByWithRelationInputObjectSchema.array()]).optional(), where: RestaurantGroupWhereInputObjectSchema.optional(), cursor: RestaurantGroupWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([RestaurantGroupScalarFieldEnumSchema, RestaurantGroupScalarFieldEnumSchema.array()]).optional() }).strict();