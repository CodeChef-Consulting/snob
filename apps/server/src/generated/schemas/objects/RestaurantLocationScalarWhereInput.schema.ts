...
const restaurantlocationscalarwhereinputSchema = z.object({
  AND: z.union([z.lazy(() => RestaurantLocationScalarWhereInputObjectSchema), z.lazy(() => RestaurantLocationScalarWhereInputObjectSchema).array()]).optional(),
  OR: z.lazy(() => RestaurantLocationScalarWhereInputObjectSchema).array().optional(),
  NOT: z.union([z.lazy(() => RestaurantLocationScalarWhereInputObjectSchema), z.lazy(() => RestaurantLocationScalarWhereInputObjectSchema).array()]).optional(),
...
export const RestaurantLocationScalarWhereInputObjectSchema: z.ZodType<Prisma.RestaurantLocationScalarWhereInput> = restaurantlocationscalarwhereinputSchema as unknown as z.ZodType<Prisma.RestaurantLocationScalarWhereInput>;
export const RestaurantLocationScalarWhereInputObjectZodSchema = restaurantlocationscalarwhereinputSchema;
