...
const makeSchema = () => z.object({
  ...
  commentId: z.number().int().optional()
        ...
        const singles: string[] = ["id","postId","commentId"] as string[];
...
export const RestaurantExtractionWhereUniqueInputObjectSchema: z.ZodType<Prisma.RestaurantExtractionWhereUniqueInput> = makeSchema() as unknown as z.ZodType<Prisma.RestaurantExtractionWhereUniqueInput>;
export const RestaurantExtractionWhereUniqueInputObjectZodSchema = makeSchema();
